...
namespace MyCms.Persistence.Migrations
{
    ...
    [Migration("20210426194956_ImageNews3")]
    partial class ImageNews3
    {
            ...
            modelBuilder.Entity("MyCms.Domain.Entities.Users.Roles", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1L,
                            InsertTime = new DateTime(2021, 4, 27, 0, 19, 55, 355, DateTimeKind.Local).AddTicks(5046),
                            IsRemoved = false,
                            Role = "Admin"
                        },
                        new
                        {
                            ID = 2L,
                            InsertTime = new DateTime(2021, 4, 27, 0, 19, 55, 360, DateTimeKind.Local).AddTicks(6917),
                            IsRemoved = false,
                            Role = "Operator"
                        },
                        new
                        {
                            ID = 3L,
                            InsertTime = new DateTime(2021, 4, 27, 0, 19, 55, 360, DateTimeKind.Local).AddTicks(7114),
                            IsRemoved = false,
                            Role = "Customer"
                        });
                });
