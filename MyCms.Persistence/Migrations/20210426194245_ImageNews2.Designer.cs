...
namespace MyCms.Persistence.Migrations
{
    ...
    [Migration("20210426194245_ImageNews2")]
    partial class ImageNews2
    {
            ...
            modelBuilder.Entity("MyCms.Domain.Entities.Users.Roles", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1L,
                            InsertTime = new DateTime(2021, 4, 27, 0, 12, 44, 908, DateTimeKind.Local).AddTicks(2852),
                            IsRemoved = false,
                            Role = "Admin"
                        },
                        new
                        {
                            ID = 2L,
                            InsertTime = new DateTime(2021, 4, 27, 0, 12, 44, 914, DateTimeKind.Local).AddTicks(2641),
                            IsRemoved = false,
                            Role = "Operator"
                        },
                        new
                        {
                            ID = 3L,
                            InsertTime = new DateTime(2021, 4, 27, 0, 12, 44, 914, DateTimeKind.Local).AddTicks(2879),
                            IsRemoved = false,
                            Role = "Customer"
                        });
                });
