...
namespace MyCms.Persistence.Migrations
{
    ...
    [Migration("20210426193949_ImageNews")]
            ...
            modelBuilder.Entity("MyCms.Domain.Entities.Users.Roles", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1L,
                            InsertTime = new DateTime(2021, 4, 27, 0, 9, 47, 263, DateTimeKind.Local).AddTicks(334),
                            IsRemoved = false,
                            Role = "Admin"
                        },
                        new
                        {
                            ID = 2L,
                            InsertTime = new DateTime(2021, 4, 27, 0, 9, 47, 268, DateTimeKind.Local).AddTicks(2353),
                            IsRemoved = false,
                            Role = "Operator"
                        },
                        new
                        {
                            ID = 3L,
                            InsertTime = new DateTime(2021, 4, 27, 0, 9, 47, 268, DateTimeKind.Local).AddTicks(2591),
                            IsRemoved = false,
                            Role = "Customer"
                        });
                });
