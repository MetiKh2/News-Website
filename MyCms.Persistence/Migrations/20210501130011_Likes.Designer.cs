...
namespace MyCms.Persistence.Migrations
{
    ...
    [Migration("20210501130011_Likes")]
    partial class Likes
    {
            ...
            modelBuilder.Entity("MyCms.Domain.Entities.Users.Roles", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1L,
                            InsertTime = new DateTime(2021, 5, 1, 17, 30, 10, 345, DateTimeKind.Local).AddTicks(3779),
                            IsRemoved = false,
                            Role = "Admin"
                        },
                        new
                        {
                            ID = 2L,
                            InsertTime = new DateTime(2021, 5, 1, 17, 30, 10, 395, DateTimeKind.Local).AddTicks(1487),
                            IsRemoved = false,
                            Role = "Operator"
                        },
                        new
                        {
                            ID = 3L,
                            InsertTime = new DateTime(2021, 5, 1, 17, 30, 10, 395, DateTimeKind.Local).AddTicks(1700),
                            IsRemoved = false,
                            Role = "Customer"
                        });
                });
