...
namespace MyCms.Persistence.Migrations
{
    ...
    [Migration("20210426190156_RepairNews")]
            ...
            modelBuilder.Entity("MyCms.Domain.Entities.Users.Roles", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1L,
                            InsertTime = new DateTime(2021, 4, 26, 23, 31, 55, 296, DateTimeKind.Local).AddTicks(1966),
                            IsRemoved = false,
                            Role = "Admin"
                        },
                        new
                        {
                            ID = 2L,
                            InsertTime = new DateTime(2021, 4, 26, 23, 31, 55, 301, DateTimeKind.Local).AddTicks(6606),
                            IsRemoved = false,
                            Role = "Operator"
                        },
                        new
                        {
                            ID = 3L,
                            InsertTime = new DateTime(2021, 4, 26, 23, 31, 55, 301, DateTimeKind.Local).AddTicks(6823),
                            IsRemoved = false,
                            Role = "Customer"
                        });
                });
