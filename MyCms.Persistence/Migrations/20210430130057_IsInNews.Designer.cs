...
namespace MyCms.Persistence.Migrations
{
    ...
    [Migration("20210430130057_IsInNews")]
    partial class IsInNews
    {
            ...
            modelBuilder.Entity("MyCms.Domain.Entities.Users.Roles", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1L,
                            InsertTime = new DateTime(2021, 4, 30, 17, 30, 56, 845, DateTimeKind.Local).AddTicks(249),
                            IsRemoved = false,
                            Role = "Admin"
                        },
                        new
                        {
                            ID = 2L,
                            InsertTime = new DateTime(2021, 4, 30, 17, 30, 56, 850, DateTimeKind.Local).AddTicks(2342),
                            IsRemoved = false,
                            Role = "Operator"
                        },
                        new
                        {
                            ID = 3L,
                            InsertTime = new DateTime(2021, 4, 30, 17, 30, 56, 850, DateTimeKind.Local).AddTicks(2567),
                            IsRemoved = false,
                            Role = "Customer"
                        });
                });
