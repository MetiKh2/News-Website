...
namespace EndPoint.Site.Controllers
{
    ...
    {
       private readonly IAddNewUserService _createUserService;
        private readonly IUserLoginService _userLoginService;
        public AuthenticationController(IAddNewUserService addNewUserService,IUserLoginService userLoginService)
        {
            _userLoginService = userLoginService;
            _createUserService = addNewUserService;
        }
        [HttpGet]
        ...
        public IActionResult SignUp(SignUpViewModel request)
        {
         ...
         string.IsNullOrWhiteSpace(request.Mobile))
            ...
            var signeupResult = _createUserService.Execute(new RequestAddUserDto()
            {
                Email = request.Email,
        ...
        [HttpPost]
        public IActionResult SignIn(string email,string password, string ReturnUrl = "/")
        {
            var signupResult = _userLoginService.Execute(password,email);
